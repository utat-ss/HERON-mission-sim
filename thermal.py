...
def T_str_dt(area_s, T_str, T_pay, T_batt, dt): 
  Q = Q_str_net(area_s, T_str, T_pay, T_batt);
...
def T_batt_dt(T_str, T_batt, batt_heat, I_t, dt): 
  Q = Q_batt_net(T_str, T_batt, batt_heat, I_t);
...
def T_pay_dt(T_str, T_pay, pay_heat, A_z, dt): 
  Q = Q_pay_net(T_str, T_pay, pay_heat, A_z);
